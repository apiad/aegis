...
class RecapNote:
    ...
    written before it existed read as done. ``task``, ``next`` and
    ``suggestion`` are the recap's standing goal, its next step, and the
    draft of the operator's own next message; older records read them as
    empty."""
